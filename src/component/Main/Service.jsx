...
function Service({ search, setSearch }) {
    ...
    return (
        ...
        <Container fluid className='mt-5'>
            ...
            <Row>
                {locandine.filter((locandina) => (locandina.type.toLowerCase().includes("servizio")) && (locandine.filter((locandina) => locandina.nameOffer.toLowerCase().includes(search.toLowerCase()))))
                    .map(locandina => (
